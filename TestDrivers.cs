...
namespace Maxit
{
    class TestDrivers
    {
        ...
        #region 1.1: Test options for rowIsEmpty()
        public static void test_options_1()
        {
            ...
            while ((choice < 1 || choice > 7) || !isNumeric)
            {
                ...
                Console.WriteLine("1. Execute test cases 1.1.1 (1x1 empty grid, size=1)");
                Console.WriteLine("2. Execute test cases 1.1.2 (1x1 non-empty grid, size = 1)");
                Console.WriteLine("3. Execute test cases 1.1.3 (4x4 empty row 0, size = 4, search in row 0)");
                Console.WriteLine("4. Execute test cases 1.1.4 (4x4 empty row 0 & partially empty row 1, size = 4, search in row 1)"); 
        ...
        #region test 1.1.2
        public static void test_1_1_2()
        {
            int[,] array = new int[1, 1] { { 1 } };
            int size = 1;   // zero based
            int row = 0;
            bool rowIsEmpty = Maxit.Program.rowIsEmpty(array, size, row);
            Console.WriteLine("Executing test 1.1.2...");
        ...
        public static void test_1_1_3()
        {
            ...
            bool rowIsEmpty = Maxit.Program.rowIsEmpty(array, size, row);
            Console.WriteLine("Executing test 1.1.3...");
            Console.WriteLine("\tExpected Value is True");
            Console.WriteLine("\tActual value is " + rowIsEmpty + "\n");
        }
        #endregion 
        ...
        public static void test_1_1_4()
        {
            ...
            bool rowIsEmpty = Maxit.Program.rowIsEmpty(array, size, row);
            Console.WriteLine("\nExecuting test 1.1.4...");
            Console.WriteLine("\tExpected Value is False");
            Console.WriteLine("\tActual value is " + rowIsEmpty + "\n");
        }
        #endregion 

        #region 1.2: Test options for columnIsEmpty()
        public static void test_options_2()
        {
            ...
            while ((choice < 1 || choice > 7) || !isNumeric)
            {
                ...
                Console.WriteLine("1. Execute test cases 1.2.1 (1x1 empty grid, size=1, row=0)");
                Console.WriteLine("2. Execute test cases 1.2.2 (1x1 non-empty grid, size=1, row=0");
                Console.WriteLine("3. Execute test cases 1.2.3 (4x4 empty column 0, size=4, search in column 0)");
                Console.WriteLine("4. Execute test cases 1.2.4 (4x4 empty column 0 & partially empty column 1, size=4, search in column 1)");
                Console.WriteLine("5. Execute all tests.");
                Console.WriteLine("6. Main menu");
                Console.WriteLine("\nEnter a selection: ");
                choiceEntry = Console.ReadLine();
        ...
        #region test 1.2.2
        public static void test_1_2_2()
        {
            int[,] array = new int[1, 1] { { 1 } };
            int size = 1;   // zero based
            int column = 0;
            bool columnIsEmpty = Maxit.Program.columnIsEmpty(array, size, column);
            Console.WriteLine("Executing test 1.2.2...");
            Console.WriteLine("\tExpected Value is False");
            Console.WriteLine("\tActual value is " + columnIsEmpty + "\n");
        }
        #endregion 
        ...
        #region test 1.2.3
        public static void test_1_2_3()
        {
            int[,] array = new int[4, 4] { { 'X',2,3,4 }, { 'X', 6, 7, 8 }, { 'X', 10, 11, 12 }, { 'X', 14, 15, 16 } };
            int size = 4;   // zero based
            int column = 0;
            bool columnIsEmpty = Maxit.Program.columnIsEmpty(array, size, column);
            Console.WriteLine("Executing test 1.2.3...");
            Console.WriteLine("\tExpected Value is True");
            Console.WriteLine("\tActual value is " + columnIsEmpty + "\n");
        }
        #endregion 
        ...
        #region test 1.2.4
        public static void test_1_2_4()
        {
            int[,] array = new int[4, 4] { { 'X', 2, 3, 4 }, { 'X', 6, 'X', 8 }, { 'X', 10, 11, 12 }, { 'X', 14, 15, 16 } };
            int size = 4;   // zero based
            int column = 1;
            bool columnIsEmpty = Maxit.Program.columnIsEmpty(array, size, column);
            Console.WriteLine("Executing test 1.2.4...");
            Console.WriteLine("\tExpected Value is False");
            Console.WriteLine("\tActual value is " + columnIsEmpty + "\n");
        }
        #endregion 

        #region 1.3: Test options for getCPUSelection()
        public static void test_options_3()
        {
            ...
            while ((choice < 1 || choice > 7) || !isNumeric)
            {
                ...
                Console.WriteLine("1. Search for maximum value in 2x2");
                Console.WriteLine("2. Search for maximum value of all negatives in a 2x2");
        ...
        #region 1.4: Test options for boardIsEmpty()
        public static void test_options_4()
        {
            ...
            while ((choice < 1 || choice > 9 || !isNumeric))
            {
                ...
                Console.WriteLine("1. 1x1 empty board");
                Console.WriteLine("2. 1x1 non-empty board");
                Console.WriteLine("3. 3x3 with 1 available");
                Console.WriteLine("4. 3x3 with 2 available");
                Console.WriteLine("5. 3x3 with all available");
                Console.WriteLine("6. 3x3 empty board"); 
        ...
        #region test 1.4.2
        public static void test_1_4_2()
        {
            int[,] array = new int[1, 1] { { 1 } };
            int size = 1;   // zero based
            bool boardIsEmpty = Maxit.Program.boardIsEmpty(size, array);
            Console.WriteLine("\nExecuting test 1.4.2...");
            Console.WriteLine("\tExpected value is False");
            Console.WriteLine("\tActual value is " + boardIsEmpty); 
        }
        #endregion 
        ...
        #region test 1.4.3
        public static void test_1_4_3()
        {
            int[,] array = new int[3, 3] { { 'X', 'X', 'X' }, { 'X', 'X', 'X' }, { 'X', 'X', 9 } };
            int size = 3;
            bool boardIsEmpty = Maxit.Program.boardIsEmpty(size, array);
            Console.WriteLine("\nExecuting test 1.4.3...");
            Console.WriteLine("\tExpected value is False");
            Console.WriteLine("\tActual value is " + boardIsEmpty);
        ...
        #region test 1.4.4
        public static void test_1_4_4()
        {
            int[,] array = new int[3, 3] { { 1, 'X', 'X' }, { 'X', 'X', 'X' }, { 'X', 'X', 9 } };
            int size = 3;
            bool boardIsEmpty = Maxit.Program.boardIsEmpty(size, array);
            Console.WriteLine("\nExecuting test 1.4.4...");
            Console.WriteLine("\tExpected value is False");
            Console.WriteLine("\tActual value is " + boardIsEmpty);
        }
        #endregion 
        ...
        #region test 1.4.5
        public static void test_1_4_5()
        {
            int[,] array = new int[3, 3] { {1,2,3},{4,5,6},{7,8,9}};
            int size = 3;
            bool boardIsEmpty = Maxit.Program.boardIsEmpty(size, array);
            Console.WriteLine("\nExecuting test 1.4.5...");
            Console.WriteLine("\tExpected value is False");
            Console.WriteLine("\tActual value is " + boardIsEmpty);
        }
        #endregion 
        ...
        #region test 1.4.6
        public static void test_1_4_6()
        {
            int[,] array = new int[3, 3] { { 'X', 'X', 'X' }, { 'X', 'X', 'X' }, { 'X', 'X', 'X' } };
            int size = 3;
            bool boardIsEmpty = Maxit.Program.boardIsEmpty(size, array);
            Console.WriteLine("\nExecuting test 1.4.6...");
            Console.WriteLine("\tExpected value is True");
            Console.WriteLine("\tActual value is " + boardIsEmpty);
        }
        #endregion
